# Callx Voice. Repo guide for future sessions.
...
A premium, multi-tenant, provider-agnostic AI voice agent platform, branded **Callx Voice**.
...
```sh
cd ~/iCloud/website/callx-voice-studio   # real path: ~/Library/Mobile Documents/com~apple~CloudDocs/website/callx-voice-studio
...
callx-voice-studio/
  ...
  public/
    ...
    assets/
      ...
      logo.svg              # Callx Voice wordmark with voltage waveform glyph (Ops)
  ...
  package.json              # name callx-voice, "start": "node server.js", no dependencies
  .gitignore
  README.md
  CLAUDE.md                 # this file
